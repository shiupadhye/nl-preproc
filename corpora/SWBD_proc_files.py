...
# to datafarme
combined_data = {"uttrID":uttr_counts,"uWordID":global_word_IDs,"word":uttr_words,"POS":POS_tags,"duration":uttr_durations,"fluency":uttr_fluencies}
combined_df = pd.DataFrame(data=combined_data)
# to csv
combined_df.to_csv("SWBD_data.csv",index=False)
